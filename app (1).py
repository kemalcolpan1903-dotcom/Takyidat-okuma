...
app = Flask(__name__)
app.config['MAX_CONTENT_LENGTH'] = 80 * 1024 * 1024  # 80 MB toplam yükleme sınırı (çok sayıda PDF için)
...
def too_large(e):
    return jsonify({
        'success': False,
        'error': 'Yüklenen dosyaların toplam boyutu izin verilen sınırı aşıyor. '
                 'Daha az sayıda PDF ile (ör. 15-20\'şer gruplar halinde) tekrar deneyin.'
    }), 413
